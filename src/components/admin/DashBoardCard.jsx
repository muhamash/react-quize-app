...
export default function DashBoardCard({ data, onEdit, onDelete }) {
    ...
    return (
        <motion.div
            ...
            className="relative p-6 rounded-lg shadow-sm border border-gray-200 w-[300px] h-[250px] overflow-hidden hover:bg-slate-300 bg-white"
